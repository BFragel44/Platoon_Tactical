...
export function openMissionSetup(root,definition,seed,onStart=null){
 ...
 const paint=()=>{root.querySelector('.mission-setup-dialog')?.remove();root.insertAdjacentHTML('beforeend',setupMarkup(preview,!!onStart));root.querySelector('#setup-close').onclick=close;const form=root.querySelector('#mission-setup-form');form.onsubmit=e=>{
