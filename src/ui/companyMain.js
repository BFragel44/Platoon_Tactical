...
function render(){
  ...
  const startMission=(definition,nextSeed,setup={})=>{
    ...
    mission=next;seed=nextSeed;combatId=null;combatStage='pre';combatOpen=true;contactAcknowledged=null;selected='co';action='ACTIVATE';target='';contributors=[];selectedPdf=null;recoveryResult=null;
